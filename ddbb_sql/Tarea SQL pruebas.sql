...
delete from backup.backup_lineaspedido where CodPedido="MF18"; -- debe borrarse este pedido del backup puesto que tiene fecha de hoy y afectaria el trigger
delete from backup.backup_pedidos where CodPedido="MF18";

insert into Pedidos values ("MF71", "2022-10-25 12:05:00", "FLC S.A", "Calle Ros de Olano 42", "007", "M-37");
insert into LineasDePedido values(7, 189, "8216", "MF71");
insert into Pedidos values ("MF91", "2022-10-25 12:27:00", "FLC S.A", "Calle Ros de Olano 42", "007", "M-43");
...
drop trigger backup.Backup_LP_Diario;
drop event backup.Backup_diario;
delete from lineasdepedido where CodPedido = "MF71";
delete from pedidos where CodPedido = "MF71";
select * from backup.backup_lineaspedido;
select * from backup.backup_pedidos;
select * from pedidos;
select * from lineasdepedido;
